...
- **Analytics UI**: `RebeccaAnalyticsTab.tsx` — 4 stat cards (Conversations/Messages/Users/Avg Turns), 4 quality metric cards (SingleTurn%/DeepConv%/MedianTurns/Feedback), daily volume BarChart (Recharts), 4 PieCharts (context/feedback/model attribution/response mode). H+ design system colors.
