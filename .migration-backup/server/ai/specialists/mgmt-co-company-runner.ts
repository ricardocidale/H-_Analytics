...
import {
  DEFAULT_COMPANY_SPECIALIST_MODEL,
  DEFAULT_COMPANY_QUANT_PANEL_MODEL,
  DEFAULT_COMPANY_MARKET_PANEL_MODEL,
  DEFAULT_COMPANY_PROMPT_ENGINEER_MODEL,
...
const COMPANY_MODEL_ID = DEFAULT_COMPANY_SPECIALIST_MODEL;
const QUANT_PANEL_MODEL_ID = DEFAULT_COMPANY_QUANT_PANEL_MODEL;
const MARKET_PANEL_MODEL_ID = DEFAULT_COMPANY_MARKET_PANEL_MODEL;
const PROMPT_ENGINEER_MODEL_ID = DEFAULT_COMPANY_PROMPT_ENGINEER_MODEL;
...
async function runSynthesisPanel(
  ...
  const result = streamObject({
    model: anthropicFactory(COMPANY_MODEL_ID),
