...
April 20, 2026 (later): 2 further sessions archived to restore 12-session cap after another 3 entries shipped in the same day (orphan detector + all-lint-batches sessions). April 18 + April 17 moved here.

April 20, 2026 (end-of-day): 3 additional sessions archived after the ADR-004/005 arc + proof-test expansion pushed count back to 15. April 19 (analyst arch + Phase 1b), April 19-20 (Phase 3b + OT-A), April 20 (SYSTEM-MODEL.md) moved here.
