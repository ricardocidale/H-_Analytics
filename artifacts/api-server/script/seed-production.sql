...
ON CONFLICT (id) DO UPDATE SET
  ...
  capital_raise_valuation_cap = EXCLUDED.capital_raise_valuation_cap, capital_raise_discount_rate = EXCLUDED.capital_raise_discount_rate,
...
INSERT INTO properties (
  ...
  0.085, 0.12,
  '59 Hazelnis Drive', 'Loch Sheldrake', 'New York', '12759', 'United States',
