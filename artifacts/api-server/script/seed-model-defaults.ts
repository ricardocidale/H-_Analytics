...
export const SPECS: SeedSpec[] = [
  ...
  // SEED: US mid-bracket statutory rate (IRS, 2024). Property-specific taxRate in DB via three-layer resolver.
  ...
  // SEED: IRS Pub 946 / USDA appraisal norms — US-typical non-depreciable land fraction.
