...
export const SEED_PROPERTY_DEFAULTS = {
  ...
  exitCapRate: DEFAULT_EXIT_CAP_RATE, taxRate: 0.25, // SEED: US mid-bracket statutory rate (IRS 2024)
...
export const SEED_INITIAL_PROPERTIES = [
  {
    ...
    roomCount: SEED_JANO_GRANDE_ROOM_COUNT,
