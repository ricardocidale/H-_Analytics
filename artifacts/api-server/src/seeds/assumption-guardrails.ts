...
const GUARDRAIL_SEEDS: GuardrailSeed[] = [
  ...
  // ── USALI operating cost rates (fraction_of_revenue) ─────────────────────
  // Keys match the assumptionKey passed to gc() in OperatingCostRatesSection.
  // Bounds sourced from USALI 12th Ed. and cited benchmarks in InfoTooltips.
  { assumptionKey: "costHousekeeping",   low: 0.120, high: 0.350, targetLow: 0.180, targetHigh: 0.270, unit: "fraction_of_revenue", rationale: "Rooms dept expense (housekeeping, labor, amenities): 18–27% of room revenue across Upper Upscale/Upscale boutique; luxury up to 28%. Outliers < 12% or > 35% indicate misclassification.", source: "USALI 12th Ed. + STR boutique benchmarks" },
  { assumptionKey: "costFB",             low: 0.030, high: 0.200, targetLow: 0.060, targetHigh: 0.120, unit: "fraction_of_revenue", rationale: "F&B dept expense 6–12% of total revenue for boutique hotels with on-site dining. <3% suggests F&B not operated; >20% signals cost-control issue.", source: "USALI 12th Ed." },
  { assumptionKey: "costAdmin",          low: 0.040, high: 0.150, targetLow: 0.070, targetHigh: 0.100, unit: "fraction_of_revenue", rationale: "Administrative & General (A&G) undistributed expense: 7–10% of total revenue per USALI. <4% unusually lean; >15% signals overhead bloat.", source: "USALI 12th Ed. + CBRE Trends 2024" },
  { assumptionKey: "costPropertyOps",   low: 0.015, high: 0.100, targetLow: 0.030, targetHigh: 0.060, unit: "fraction_of_revenue", rationale: "Property Operations & Maintenance (POM): 3–6% of total revenue per USALI. <1.5% defers maintenance; >10% signals major deferred-repair catch-up.", source: "USALI 12th Ed. + PKF" },
  { assumptionKey: "costUtilities",     low: 0.020, high: 0.120, targetLow: 0.040, targetHigh: 0.070, unit: "fraction_of_revenue", rationale: "Utilities (electricity, gas, water, waste): 4–7% of total revenue per USALI. >12% indicates energy-inefficient facility; <2% likely excludes some utility lines.", source: "USALI 12th Ed. + CBRE Energy Benchmarks" },
  { assumptionKey: "costFFE",           low: 0.010, high: 0.080, targetLow: 0.030, targetHigh: 0.050, unit: "fraction_of_revenue", rationale: "FF&E Reserve (furniture, fixtures & equipment replacement): 3–5% of total revenue per USALI 12th Ed. and standard lender covenants. <1% increases deferred-CapEx risk; >8% is above typical lender ceilings.", source: "USALI 12th Ed. + HVS lender survey" },
  { assumptionKey: "costOther",         low: 0.010, high: 0.100, targetLow: 0.030, targetHigh: 0.060, unit: "fraction_of_revenue", rationale: "Other undistributed expenses (laundry, parking, telecom, misc.): 3–6% of total revenue. <1% likely incomplete; >10% warrants itemization.", source: "USALI 12th Ed." },
  { assumptionKey: "costMarketing",     low: 0.005, high: 0.080, targetLow: 0.010, targetHigh: 0.040, unit: "fraction_of_revenue", rationale: "Sales & Marketing: 1–4% of total revenue for boutique hotels; resort/destination properties can reach 6–8%. <0.5% signals underinvestment; >8% is atypical for non-resort independent.", source: "USALI 12th Ed. + STR boutique benchmarks" },
  { assumptionKey: "costIT",            low: 0.001, high: 0.025, targetLow: 0.003, targetHigh: 0.010, unit: "fraction_of_revenue", rationale: "Information Technology: 0.3–1.0% of total revenue per USALI 12th Ed. and HFTP Technology Survey. <0.1% suggests PMS/WiFi costs missing; >2.5% warrants vendor review.", source: "USALI 12th Ed. + HFTP Technology Survey 2024" },

  // ── USALI fixed charges based on property value (fraction_of_property_value)
  { assumptionKey: "costPropertyTaxes", low: 0.010, high: 0.060, targetLow: 0.015, targetHigh: 0.040, unit: "fraction_of_property_value", rationale: "Property taxes: 1.5–4% of assessed value for hospitality assets; varies significantly by jurisdiction (NJ ≈1.8%, NY ≈1.5%, CA ≈1.25%). Outliers <1% or >6% warrant jurisdiction verification.", source: "USALI 12th Ed. + CBRE Property Tax Benchmarks 2024" },
];
