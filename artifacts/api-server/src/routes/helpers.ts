...
export function userResponse(u: any, extra?: Record<string, any>) {
  return { 
    ...
    assignedScenarioId: u.assignedScenarioId ?? null,
    rebeccaOptOut: u.rebeccaOptOut ?? false,
    rebeccaRailOpen: u.rebeccaRailOpen ?? false,
...
export const researchGenerateSchema = z.object({
  ...
  propertyContext: z.record(z.string(), z.any()).optional(),
  assetDefinition: z.record(z.string(), z.any()).optional(),
...
export const icpGenerateSchema = z.object({
  promptBuilder: z.record(z.string(), z.any()).optional(),
});
