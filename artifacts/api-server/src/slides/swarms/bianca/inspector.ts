...
export async function runBiancaInspector(
  ...
  const response = await anthropic.messages.create({
    ...
    system:
      ...
      "coherent, substantive, and fits a photo gallery / operational showcase context for the subject property. " +
    ...
    messages: [
      {
        ...
        content: [
          ...
          },
          {
            type: "text",
            text:
              "Above is the canonical Slide 2 LAYOUT reference (960×540 px). " +
