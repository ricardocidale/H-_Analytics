...
export const FALLBACK_MODELS: AiModelEntry[] = [
  ...
  // OpenAI
  { id: "gpt-5.1",      label: "OpenAI GPT-5.1",      provider: "openai" },
  { id: "gpt-5-mini",   label: "OpenAI GPT-5 Mini",   provider: "openai" },
  { id: "gpt-5-nano",   label: "OpenAI GPT-5 Nano",   provider: "openai" },
  { id: "gpt-4.1",      label: "OpenAI GPT-4.1",      provider: "openai" },
  { id: "gpt-4.1-mini", label: "OpenAI GPT-4.1 Mini", provider: "openai" },
  { id: "gpt-4.1-nano", label: "OpenAI GPT-4.1 Nano", provider: "openai" },
  ...
  { id: "gemini-2.5-flash-lite", label: "Google Gemini 2.5 Flash Lite", provider: "google" },
  { id: "gemini-2.0-flash",      label: "Google Gemini 2.0 Flash",      provider: "google" },
  { id: "gemini-2.0-flash-lite", label: "Google Gemini 2.0 Flash Lite", provider: "google" },
  // xAI
  { id: "grok-4",           label: "xAI Grok 4",           provider: "xai" },
  { id: "grok-4-fast",      label: "xAI Grok 4 Fast",      provider: "xai" },
  { id: "grok-4.1-fast",    label: "xAI Grok 4.1 Fast",    provider: "xai" },
  { id: "grok-3",           label: "xAI Grok 3",           provider: "xai" },
  { id: "grok-3-mini",      label: "xAI Grok 3 Mini",      provider: "xai" },
  { id: "grok-code-fast-1", label: "xAI Grok Code Fast 1", provider: "xai" },
];
