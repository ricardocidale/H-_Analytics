...
import AsPurchasedDescriptionField from "./AsPurchasedDescriptionField";
 ...
 *  Spacing snaps to the H+ 8px grid (`mb-4` = 16px). */
...
// AsPurchasedDescriptionField extracted to ./AsPurchasedDescriptionField.tsx
// (Plan 2026-05-13-002 U4 — was a 167-line inline helper, above the 60-line
// extract threshold).
      ...
      <div className="relative p-6">
        ...
        <div className="mt-8 border-t border-border/50 pt-6">
          <SubsectionHeader
            ...
            className="mb-4"
          />
          <p className="text-xs text-muted-foreground mb-4 -mt-2 ml-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-card border-primary/30 text-foreground placeholder:text-muted-foreground/60 focus:placeholder:text-muted-foreground"
