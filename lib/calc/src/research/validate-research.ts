...
import { RESEARCH_CAP_RATE_VALUATION_MAX_MULTIPLIER, RESEARCH_CAP_RATE_VALUATION_MIN_MULTIPLIER } from "@shared/constants";
import type { BusinessModelType } from "@shared/constants";
