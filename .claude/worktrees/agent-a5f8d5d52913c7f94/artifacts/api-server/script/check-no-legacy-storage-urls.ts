...
import { findNonCommentMatches } from "./lib/comment-scan";

const ALLOW_LIST = [
  // Wrapped Replit Object Storage SDK calls.
  "src/replit_integrations/",
  // Legacy provider adapter that knows how to talk to the Replit sidecar.
  "src/providers/storage/replit-storage.ts",
  ...
  "src/lib/canonical-asset-url.ts",
  "src/ai/asset-intelligence.ts",
...
const SEARCH_GLOBS = [
  ...
  "../../lib/analytics/src",
  "../../lib/domain/src",
  "../hospitality-business-portal/src",
];
...
// Only run when invoked directly via tsx/node on this exact script file.
// In bundled output (dist/index.mjs) this check would erroneously match
// because import.meta.url and process.argv[1] both point to the bundle.
