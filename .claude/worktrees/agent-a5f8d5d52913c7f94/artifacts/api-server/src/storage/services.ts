import { companyServiceTemplates, propertyFeeCategories, properties, type ServiceTemplate, type InsertServiceTemplate, type UpdateServiceTemplate } from "@workspace/db";
import { db } from "../db";
