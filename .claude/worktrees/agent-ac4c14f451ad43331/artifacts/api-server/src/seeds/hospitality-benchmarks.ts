...
import { db } from "../db";
import { hospitalityBenchmarks } from "@workspace/db";
...
const BENCHMARK_SEEDS: BenchmarkSeed[] = [
  // ── ADR Benchmarks ────────────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://str.com/data-solutions/industry-trend-reports", country: "US",
    notes: "All chain scales combined",
  },
  {
  ...
  },
  {
    ...
    sourceUrl: "https://str.com/data-solutions/industry-trend-reports", country: "US",
    notes: "Boutique Lifestyle Lodging Association data cross-referenced with STR",
  },
  ...
  // ── Cap Rate Benchmarks ───────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://www.cbre.com/insights/figures/us-cap-rate-survey", country: "US",
    notes: "All service tiers combined",
  },
  {
  ...
  // ── Cost Rate Benchmarks ──────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://www.ishc.com/publications", country: "US",
    notes: "Percentage of total revenue for furniture, fixtures & equipment reserve",
  },
  {
    ...
    sourceUrl: "https://www.aahoa.com/resources", country: "US",
    notes: "Percentage of total revenue",
  },
  {
    ...
    sourceUrl: "https://www.pkf.com/hospitality-research", country: "US",
    notes: "Percentage of assessed value; varies significantly by jurisdiction",
  },
  ...
  // ── Fee Rate Benchmarks ───────────────────────────────────────────────
  {
    ...
    sourceUrl: "https://www.hvs.com/publications", country: "US",
    notes: "Base management fee as percentage of total revenue",
  },
  {
    ...
    sourceYear: 2024, sourceName: "HVS 2024",
    sourceUrl: "https://www.hvs.com/publications", country: "US",
    notes: "Incentive management fee as percentage of gross operating profit",
  },
  ...
  },
  {
    ...
    sourceYear: 2024, sourceName: "Colombian Tax Code (Estatuto Tributario Art. 137)",
    sourceUrl: "https://www.dian.gov.co", country: "CO",
  ...
  },
  {
    ...
    sourceUrl: "https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/sole-proprietorships-partnerships/report-business-income-expenses/claiming-capital-cost-allowance/classes-depreciable-property.html", country: "CA",
  ...
  },
  {
    ...
    sourceYear: 2024, sourceName: "French Tax Code (CGI Art. 39)",
    sourceUrl: "https://www.legifrance.gouv.fr", country: "FR",
  ...
  },
  {
    ...
    sourceYear: 2024, sourceName: "Spanish Tax Code (Ley 27/2014 Art. 12)",
    sourceUrl: "https://www.agenciatributaria.es", country: "ES",
  ...
  },
  {
    ...
    sourceUrl: "https://www.irs.gov/businesses/cost-segregation-audit-techniques-guide-table-of-contents", country: "US",
