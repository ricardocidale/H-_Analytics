import { designThemes, logos, assetDescriptions, researchQuestions, companies, type DesignTheme, type InsertDesignTheme, type Logo, type InsertLogo, type AssetDescription, type ResearchQuestion, type InsertResearchQuestion } from "@workspace/db";
import { db } from "../db";
