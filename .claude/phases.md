...
| P6 | Resources adapters for legacy `data_sources` / `LlmDefaultsTab`; centralize `SPECIALIST_SECTION_TO_ID`; Required Fields enforcement; audit user-name resolution; runtimeConfig schema narrowing | ⏳ Pending | Replit (planned) | — | P5 ✅ | Author packet `phase-6-resources-adapters.md` per `_TEMPLATE.md` |
