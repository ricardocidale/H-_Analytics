...
| G2-v1 | Revenue (B) v1 — single-shot Opus + careful prompt + rich context | ⏳ Pending | CC | — | G1.5c ✅ (1 session soak done 2026-04-28) | Same v1 pattern as G1.5c-v1; `runRevenueSpecialist(...)` wires via `analyst-admin.ts` branch on `mgmt-co.revenue` scope. |
