...
| P7-B | Remaining mgmt-co Specialists — Compensation, Overhead, Company, Property-Defaults (Analyst Architecture Phase 4) | ✅ Shipped | CC + Replit | Compensation (Mariana / M) shipped: Phase 1 `889dcd59`, Phase 2 G3 N+1 `36db0f45`, Phase 3 IB bench + api assignmentRef `05789a2a`, Voice unit hardening `f202b146`. Overhead (Natália / N) shipped: Phase 1 `3a173ee9` (paired with range-shaped defaults doctrine `7284d428`), Phase 2 Tier-1 N+1 `495803ee`, Phase 3 IB bench `05a5d44a`. Company (Olívia / O) shipped: Phase 1 `2588f4fd`, Phase 2 Tier-1 N+1 `43541a0e`, Phase 3 IB bench `eaebd3fa`. Property-Defaults (Paula / P) shipped: Phase 1 `4cb664b9`, Phase 2 N+1 `43541a0e`, Phase 3 IB bench `fc5d8c99`. All 4 specialists complete. | P7-A ✅ | P7-C ⏳ |
| P7-C | Constants Specialists H–K admin pages (`status: "needs-page"` → built) | ✅ Shipped | Replit + CC | ConstantsOwnedCard + SpecialistPage mount `03d5ceb7` (Replit). Catalog status flip + both exempt sets `76525c11` (CC). | P6 ✅ | — |
| P7-D | Market Data Tables admin page + AI Intelligence wiring + sidebar rename | ✅ Shipped | Replit | S1 `69709b1e`, S2 `5da1d350`, S3 `fb80c767` | P7-C ✅ | — |
...
| Phase | Scope | Status | Owner | Commit/PR | Blocked-by | Next |
|---|---|---|---|---|---|---|
| 8 | Platform Independence | ✅ Shipped | CC+Replit | 9c86f8f6 | — | 8.2+8.3+8.4+8.7 shipped (docker, Dockerfile, S3, migrations); 8.5 shipped (Replit decoupling: delete replit_integrations/, .replit, replit.nix, move CSP+session+objects to clean providers) |
...
| 11 | Export Excellence (3–5 wk est.) | ⏳ Pending | Replit | — | — | Phase 8 gate cleared |
| 12 | Knowledge & Onboarding (4–6 wk est.) | ⏳ Pending | Replit | — | — | Video content is separate workstream |
| 13 | Scale & Performance (6–8 wk est.) | ⏳ Pending | Replit | — | — | Multi-org migration = riskiest schema change |
