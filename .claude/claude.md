...
| Proof System | `.claude/skills/proof-system/SKILL.md` | 4,495 tests across 185 files, 583 golden values, 15-phase verification pipeline |
...
**Commands**: `npm test` (all 4,495 tests, 185 files) · `npm run verify` (15-phase GAAP) · `npm run health` (tsc+tests+verify+doc harmony)
