...
describe("SPECIALIST_CATALOG (P1 doctrine lock)", () => {
  ...
  it("declares exactly 16 Specialists (A–G + Constants H–K + Resource Builder L + Compensation M + Overhead N + Company O + Property-Defaults P)", () => {
    expect(SPECIALIST_CATALOG).toHaveLength(16);
  });
