...
- **Financial Accuracy & Compliance:** Highest priority, enforced by a comprehensive proof system (4,024 tests across 172 files), GAAP verification, and USALI 12th Edition compliance. Precision is hardened using `decimal.js`-backed arithmetic.
...
npm run test:summary   # All 4,024 tests, 172 files (~35s)
