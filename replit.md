...
- **Financial Accuracy & Compliance:** Highest priority, enforced by a comprehensive proof system (3,980 tests across 170 files), GAAP verification, and USALI 12th Edition compliance. Precision is hardened using `decimal.js`-backed arithmetic.
...
npm run test:summary   # All 3,980 tests, 170 files (~35s)
