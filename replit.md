...
- **Research Intelligence Redesign:** A major architectural evolution of the research system, introducing a Star Rating System, Hotel vs Resort Classification, Entity Context Packs, 3-Tier Intelligence (ambient, entity-scoped, deep-dive), Progressive Relaxation for comparable sets, and Rebecca as a conversational AI layer for guidance. New database tables `assumption_guidance`, `research_runs`, `benchmark_snapshots`, `relaxation_traces`, `guidance_decisions`, `rebecca_conversations`, `rebecca_messages`, `rebecca_emails`, `rebecca_feedback`, `coverage_snapshots`, `source_registry`, `integration_key_rotations`, `pipeline_policies` have been implemented.
