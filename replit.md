...
- **Financial Accuracy & Compliance:** Highest priority, enforced by a comprehensive proof system (4,045 tests across 173 files), GAAP verification, and USALI 12th Edition compliance. Precision is hardened using `decimal.js`-backed arithmetic.
...
npm run test:summary   # All 4,045 tests, 173 files (~35s)
